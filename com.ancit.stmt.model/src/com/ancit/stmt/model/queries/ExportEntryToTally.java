...
public class ExportEntryToTally {
	...
	public void exportEntryToTally(Group bankGroup, Entry entry, Group group) {
		...
		String voucherQuery = "<VOUCHER VCHTYPE=\"" + vchType
				+ "\" ACTION=\"Create\">" + "<VOUCHERTYPENAME>" + vchType
				+ "</VOUCHERTYPENAME>" + "<DATE>" + date + "</DATE>"
				+ "<EFFECTIVEDATE>" + date + "</EFFECTIVEDATE>"
				+ "<PARTYLEDGERNAME>" + group.getName() + "</PARTYLEDGERNAME>"
				+ "<NARRATION>" + description + "</NARRATION>"
				+ "<ALLLEDGERENTRIES.LIST>" + debitString
				+ "</ALLLEDGERENTRIES.LIST>" + "<ALLLEDGERENTRIES.LIST>"
				+ creditString + "</ALLLEDGERENTRIES.LIST>" + "</VOUCHER>";
